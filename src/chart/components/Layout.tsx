...
export const Layout = () => {
  const { useStore, useProps, useSidebar } = useChartStore();
  ...
  const ignoreSidebar = useProps((s) => s.ignoreSidebar);
  ...
  const sidebarWidth = useSidebar((s) => s.sidebarWidth);
  const sidebarOpened = useSidebar((s) => s.sidebarOpened);
